...
{
    internal class TestDocumentWithTwoMigrationMiddleVersion_0_0_1 : DocumentMigration<TestDocumentWithTwoMigrationMiddleVersion>
    {
        public TestDocumentWithTwoMigrationMiddleVersion_0_0_1() : base("0.0.1")
        {
        }
